...
public class TextManager : MonoBehaviour
{
	...
	public void DisplayMessage (string message, CharacterProps characterProps, float delay)
	{
		DisplayMessage (message, characterProps, delay, false);
	}

	public void DisplayMessage (string message, CharacterProps characterProps, float delay, bool dontClear) 
    {
		...
		float newClearTime = startTime + (dontClear ? float.MaxValue : displayDuration);
        ...
        {
            message = message,
			textColor = characterProps ? characterProps.textColor : Color.black,
            startTime = startTime
        };
