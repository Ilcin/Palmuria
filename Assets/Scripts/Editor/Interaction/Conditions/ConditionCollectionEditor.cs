...
public class ConditionCollectionEditor : EditorWithSubEditors<ConditionEditor, Condition>
{
	...
	private SerializedProperty requiredSelectedItemProperty;
	...
	private const string conditionCollectionPropRequiredSelectedItemName = "requiredSelectedItem";
    ...
    private void OnEnable ()
    {
		...
		requiredSelectedItemProperty = serializedObject.FindProperty (conditionCollectionPropRequiredSelectedItemName);
    ...
    private void ExpandedGUI ()
    {
		...
		EditorGUILayout.PropertyField (requiredSelectedItemProperty);
