...
public class ReactionCollectionEditor : EditorWithSubEditors<ReactionEditor, Reaction>
{
	...
	private SerializedProperty randomReactionProperty;
	...
	private const string randomReactionPropName = "randomReaction";
    ...
    private void OnEnable ()
    {
		...
		randomReactionProperty = serializedObject.FindProperty(randomReactionPropName);
    ...
    public override void OnInspectorGUI ()
    {
		...
		randomReactionProperty.boolValue = GUILayout.Toggle (randomReactionProperty.boolValue, "Random reaction");
